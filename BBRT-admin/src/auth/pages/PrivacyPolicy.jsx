            ...
            <div className="flex justify-center items-start w-full min-h-screen p-4 sm:p-6 md:p-8">
                <div className="w-full max-w-4xl bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 sm:p-8 md:p-10 my-8">
                    ...
                    <div className="space-y-6 text-sm text-gray-700 dark:text-gray-300">
                        <p>
                            BBRTek (“we”, “our”, or “us”) respects your privacy. This Privacy Policy explains how we handle your information when you use our app and related services.
                        </p>
                        ...
                        <div>
                            ...
                            <p>Email: <a href="mailto:support@BBRTek.space" className="text-primary hover:underline">support@BBRTek.space</a></p>
                        </div>
                    </div>
                </div>
            </div>
