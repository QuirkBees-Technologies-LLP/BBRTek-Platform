    ...
    return (
        <main
            ...
            <div className="relative w-full max-w-[600px] overflow-hidden rounded-2xl border border-white/10 bg-gray-900/95 p-8 text-center shadow-2xl backdrop-blur-lg sm:p-12 md:p-16 lg:p-20 bg-gray-900">
                ...
                {/* Send Email Button */}
                <a
                    href="mailto:Support@BBRTek.space?subject=Support%20Request&body=Hello%20BBRTek%20Support%20Team%2C%0A%0AI%20need%20assistance%20with%3A%0A%0A%5BPlease%20describe%20your%20issue%20here%5D%0A%0AThank%20you%21"
