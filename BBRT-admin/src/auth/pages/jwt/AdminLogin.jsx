    ...
    <div className="login card max-w-[385px] border-none w-full bg-[linear-gradient(180deg,#1F1E1F_0%,#121213_100%)]">
      <form className="card-body flex flex-col gap-5 p-7" noValidate>
        <div className="text-center mb-2.5">
          <div className="text-center">
            ...
            <div className="flex justify-center mb-8">
              <img src="/media/app/logo.png" className="w-100 h-10" alt="" />
        ...
        <button
          ...
          className="btn py-7 rounded-2xl bg-[linear-gradient(90deg,#e87811_0%,#e87811_100%)] btn-primary flex justify-center grow text-dark"
